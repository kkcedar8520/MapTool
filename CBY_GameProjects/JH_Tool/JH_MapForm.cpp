...
JH_MapForm::JH_MapForm()
	...
	, m_iCellCount(2)
	, m_iCellSize(1)
	, m_TextrueName(_T("../../data/map/Sand_Dunes_A/Sand_Dunes_A_Albedo.tif"))
	, m_NormalMapFile(_T("../../data/map/Sand_Dunes_A/Sand_Dunes_A_Normal.tif"))
	, m_HeightMapFile(_T("../../data/map/map/Rubber/Generic_Rubber_A/Generic_Rubber_A_Height_129.bmp"))
	, m_Brush(_T(""))
	, m_SplattTexture1(_T(""))
	, m_SplattTexture2(_T(""))
	, m_SplattTexture3(_T(""))
